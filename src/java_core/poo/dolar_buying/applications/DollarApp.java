package java_core.poo.dolar_buying.applications;

import java.util.Scanner;
import java.util.Locale;

import java_core.poo.dolar_buying.entites.Dollar;
import java_core.poo.dolar_buying.converters.CurrencyConverter;
